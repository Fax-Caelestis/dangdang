...
<html>
  ...
  <body style="text-align: center;background-color: #d4e7f0">  <!-- #f0f9fd -->
   	...
   	<div style="text-align: center" class="div1">
   		<div class="aa">
			<a style="text-decoration: none;" href="${path}/category/queryAll" target="Homepage">类别管理</a><br/><br/>
		</div>
		<div class="aa">
  		...
  		<div class="aa">
  			<a style="text-decoration: none;" href="${path}/user/queryAll" target="Homepage">用户管理</a><br/><br/>
  		</div>
  	</div>
  </body>
</html>
