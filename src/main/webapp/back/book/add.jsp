...
<body
	...
	<hr />
	<div align="center">
		<form action="${pageContext.request.contextPath }/book/insertBook" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>名称：</td>
					<td><input type="text" name="bname" class="el-input__inner"></td>
				...
				<tr>
					<td>所属分类：</td>
					<td>
						<select name="categoryid" class="el-select__inner inner2">
				...
				<tr>
					...
					<td>编辑推荐：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="editorrecommend"></textarea></td>
				</tr>
				<tr>
					<td>出版社：</td>
				...
				<tr>
					<td>出版时间：</td>
					<td><input type="date" name="pressdate" class="el-input__inner"></td>
					<td>内容简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="contentabstortact"></textarea></td>
				</tr>
				<tr>
					<td>版次：</td>
				...
				<tr>
					<td>印刷时间：</td>
					<td><input type="date" name="printdate" class="el-input__inner"></td>
					<td>作者简介：</td>
				...
				<tr>
					...
					<td>基本目录：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="driector"></textarea></td>
				</tr>
				<tr>
					<td>开本：</td>
					<td><input type="text" name="bsize" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>纸张：</td>
					...
					<td>媒体评论：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="mediacomentary"></textarea></td>
				</tr>
				<tr>
					<td>包装：</td>
