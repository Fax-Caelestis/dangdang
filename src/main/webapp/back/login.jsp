...
<body>
	 <script type="text/javascript">
	  	function chgCode() {
			var imgObj=document.getElementById("imgVcode");
			imgObj.src="${path }/Admin/ImagerAction?xx="+Math.random();
		}
							...
							<div id="J_captchVcodeWrap" style="" class="Captcha">
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="a" href="javascript:void(0);">
											<img id="imgVcode" src="${path}/Admin/ImagerAction"  class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
										<a id="vcodeImgBtn" name="change_code_link" class="code_picww" href="javascript:void(0)"  onclick="chgCode()">换张图</a> 
