	...
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				...
				<h5>
					<font style='color: #cc3300'><strong>${user.nick_name}</strong></font>，欢迎加入当当网
				</h5>
				<h6>
					请牢记您的登录邮件地址：<font style='color: #cc3300'><strong>${user.email}</strong></font>
				</h6>
				...
				<ul>
					...
					<li>
						进入“
						<a href="${path}/book/main">我的当当</a>”查看并管理您的个人信息
					</li>
					<li>
